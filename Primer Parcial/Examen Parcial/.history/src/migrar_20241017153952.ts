...
const datos = {
    vehiculos: [
        { descripcion: 'Sedan', placa: 'ASD123', color: 'Rojo' },
        ...
        // { descripcion: 'Sedan', placa: 'PQR123', color: 'Rojo' },
        // { descripcion: 'SUV', placa: 'STU456', color: 'Azul' },
        // { descripcion: 'Coupé', placa: 'VWX789', color: 'Verde' },
        // { descripcion: 'Convertible', placa: 'YZA012', color: 'Amarillo' },
        // { descripcion: 'Furgoneta', placa: 'BCD345', color: 'Negro' }
    ],
    espacios: [
        { descripcion: 'Espacio 12' },
