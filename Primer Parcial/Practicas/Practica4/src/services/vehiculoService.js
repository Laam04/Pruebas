...
function obtenerVehiculos() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, vehiculo_1.Vehiculo.find().exec()];
        });
    });
}
// Cambia el tipo de parámetro en crearVehiculo
function crearVehiculo(vehiculoData) {
    return __awaiter(this, void 0, void 0, function () {
        var nuevoVehiculo;
        return __generator(this, function (_a) {
            nuevoVehiculo = new vehiculo_1.Vehiculo(vehiculoData);
            return [2 /*return*/, nuevoVehiculo.save()];
        });
    });
}
