...
router.post('/', async (req, res) => {
    try {
        const { espacioId, vehiculoId, fechaHoraEntrada, fechaHoraSalida } = req.body;
        ...
        const nuevoParquear = parquearRepository.create({
            ...
            fechaHoraEntrada: new Date(fechaHoraEntrada), // Asegúrate de que el formato sea correcto
            fechaHoraSalida: new Date (fechaHoraSalida), // Asegúrate de que el formato sea correcto
