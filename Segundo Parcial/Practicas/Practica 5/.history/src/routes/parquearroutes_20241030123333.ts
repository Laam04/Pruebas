...
router.post('/', async (req, res) => {
    try {
        ...
        const espacio = await espacioRepository.findOneBy({ id: espacioId }); // Usa el repositorio
        const vehiculo = await vehiculoRepository.findOneBy({ id: vehiculoId }); // Usa el repositorio
